      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4 space-y-4">
            <h3 className="text-lg font-semibold text-zinc-900">MemeGen</h3>
            <p className="text-sm text-zinc-600 max-w-xs">
              The fastest way to launch your memecoin website. Built with modern tech stack and Solana blockchain integration.
            </p>
          </div>

          {/* Quick Links */}
          <div className="md:col-span-4 space-y-4">
            <h3 className="text-sm font-semibold text-zinc-900 uppercase tracking-wider">Quick Links</h3>
            <div className="grid grid-cols-2 gap-4">
              <ul className="space-y-3">
                <li>
                  <Link href="/dashboard" className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors">
                    Dashboard
                  </Link>
                </li>
                <li>
                  <Link href="/templates" className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors">
                    Templates
                  </Link>
                </li>
                <li>
          ...
          <div className="md:col-span-4 md:flex md:justify-end space-y-4">
            <div>
              <div className="flex justify-end">
                <h3 className="text-sm font-semibold text-zinc-900 uppercase tracking-wider">Connect</h3>
              </div>
