        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          ...
          <nav className="md:col-span-4 order-2">
            ...
            <ul className="grid grid-cols-2 gap-x-8 gap-y-3">
              <li>
                <Link href="/dashboard" className="text-sm text-zinc-500 hover:text-zinc-900 transition-colors duration-200">
                  Dashboard
                </Link>
              </li>
              <li>
                <Link href="/templates" className="text-sm text-zinc-500 hover:text-zinc-900 transition-colors duration-200">
                  Templates
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-sm text-zinc-500 hover:text-zinc-900 transition-colors duration-200">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/docs" className="text-sm text-zinc-500 hover:text-zinc-900 transition-colors duration-200">
                  Docs
                </Link>
              </li>
              <li>
                <Link href="https://buidl.openstatus.dev/" target="_blank" rel="noopener noreferrer" 
              ...
              <li>
                <Link href="/about" className="text-sm text-zinc-500 hover:text-zinc-900 transition-colors duration-200">
                  About
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-3 order-3 md:justify-self-end">
            ...
            <div className="flex gap-6">
              ...
              >
                ...
                <svg className="h-5 w-5 mt-[0.05rem]" fill="currentColor" viewBox="0 0 24 24">
