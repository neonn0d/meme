...
export function BasicInfoForm({ fields, onChange }: BasicInfoFormProps) {
  ...
  const randomizeColors = () => {
    let availableIndices = Array.from({ length: colorPairs.length }, (_, i) => i)
          ...
          <div className="bg-white rounded-lg border shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden">
            <div className="p-4 bg-gradient-to-br from-red-500/5 to-red-500/10 border-b">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <Label htmlFor="primaryColor" className="font-medium text-base">
                    Primary Color
                  </Label>
                  <p className="text-sm text-gray-500">Main color for your website</p>
                </div>
              </div>
            </div>
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg border shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden">
            <div className="p-4 bg-gradient-to-br from-purple-500/5 to-purple-500/10 border-b">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <Label htmlFor="secondaryColor" className="font-medium text-base">
                    Secondary Color
                  </Label>
                  <p className="text-sm text-gray-500">Accent color for your website</p>
                </div>
              </div>
            </div>
            <div className="p-4">
